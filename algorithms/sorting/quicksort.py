class QuickSort:
    ...
    # The Quicksort algorithm takes an array of values, chooses one of the 
    # values as the 'pivot' element, and moves the other values so that 
    # lower values are on the left of the pivot element, and higher values
